...
class AStarPlanner:
    ...
    def get_motion_model():
        ...
        motion = [[1, 0, 1],
                  ...
                  [-1, 0, 1],
                  [0, -1, 1],
                  [-1, -1, 1.2],# sqrt2 is original euclid parameter but recoomened  1.2 for move smoothly 
                  [-1, 1, 1.2],
                  [1, -1, 1.2],
                  [1, 1, 1.2]]
...
class MyNode(Node):
    ...
    def __init__(self):
        ...
        self.path_calculating = False  # 경로 계산 중 플래그 초기화
    ...
    def astar_planner(self,msg):
        ...
        grid_size = 0.5
        robot_radius =  0.15/map_.info.resolution
